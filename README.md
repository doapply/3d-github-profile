...
* `SETTING_JSON` : (optional) settings json file path. See `sample-settings/*.json` and `src/type.ts` in `doapply/3d-github-profile` repository for details. - since ver. 0.6.0
